...
class KeyboardMapper:
    ...
    LEFT_CHARS = set('qwertasdfgzxcvb1234567890-=`~!@#$%^')
    RIGHT_CHARS = set('yuiophjklnm[]\\;\',./?+_{}|:"<>*&()') 
...
def test_keyboard_mapper():
    ...
    assert mapper.char_to_pattern('!') == 'L', "! should be Left"
    assert mapper.char_to_pattern('?') == 'R', "? should be Right"
